...
class ItemCardMinimized extends StatefulWidget {
  ItemCardMinimized(
      {super.key,
      required this.item_id,
      required this.element,
  ...
  int chack = 1;
  @override
  State<ItemCardMinimized> createState() => _ItemCardMinimizedState();
}

class _ItemCardMinimizedState extends State<ItemCardMinimized> {
  Map<String, dynamic> element = {};
  List<InlineSpan> propertiesWidget = [];
  late BuyButton _buyButton;
  late int chack;
