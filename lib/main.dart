...
Future<void> main() async {
  ...
  final diagnosticsEnabled = await DiagnosticsConsentService.isDiagnosticsEnabled();

  if (diagnosticsEnabled && SentryService.hasConfiguredDsn) {
    final sentryInitialized = await SentryService.initialize(
      consentSource: 'startup',
      appRunner: () async {
...
class _MainState extends State<Main> with LocationMixin {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      navigatorObservers: [routeObserver, SentryService.navigatorObserver],
      ...
      theme: ThemeData(
        ...
        appBarTheme: AppBarTheme(backgroundColor: Color(0xffF9F9F9), foregroundColor: Colors.black),
      ...
      darkTheme: ThemeData(
        ...
        appBarTheme: AppBarTheme(backgroundColor: Color(0xFF0a0a0a), surfaceTintColor: Color(0xFF0a0a0a), foregroundColor: Colors.white),
